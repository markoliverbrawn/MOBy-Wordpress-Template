...
function updateViewportDimensions(){var e=window,t=document,n=t.documentElement,a=t.getElementsByTagName("body")[0],i=e.innerWidth||n.clientWidth||a.clientWidth,o=e.innerHeight||n.clientHeight||a.clientHeight;return{width:i,height:o}}function loadGravatars(){viewport=updateViewportDimensions(),viewport.width>=768&&jQuery(".comment img[data-gravatar]").each(function(){jQuery(this).attr("src",jQuery(this).attr("data-gravatar"))})}function MOB_show_slider_panels(e){var t=e.find("h2"),n=e.find(".content");Math.random()<.33?t.delay(500).fadeIn(function(){n.fadeIn()}):t.delay(500).slideDown({duration:400,easing:"easeOutBack",complete:function(){n.slideDown({duration:400,easing:"easeOutBack"})}})}function MOB_createCookie(e,t,n){var a;if(n){var i=new Date;i.setTime(i.getTime()+24*n*60*60*1e3),a="; expires="+i.toGMTString()}else a="";document.cookie=escape(e)+"="+escape(t)+a+"; path=/"}function MOB_readCookie(e){for(var t=escape(e)+"=",n=document.cookie.split(";"),a=0;a<n.length;a++){for(var i=n[a];" "===i.charAt(0);)i=i.substring(1,i.length);if(0===i.indexOf(t))return unescape(i.substring(t.length,i.length))}return null}function MOB_eraseCookie(e){createCookie(e,"",-1)}var viewport=updateViewportDimensions(),waitForFinalEvent=function(){var e={};return function(t,n,a){a||(a="Don't call this twice without a uniqueId"),e[a]&&clearTimeout(e[a]),e[a]=setTimeout(t,n)}}(),timeToWaitForLast=100;jQuery(document).ready(function(e){loadGravatars(),e(".menu").parent().prev(".widgettitle").click(function(t){e(".mnavexp").is(":visible")&&e(t.currentTarget).next().find(".menu").slideToggle()}),e(".mnavexp").click(function(t){e(t.currentTarget).next("ul").slideToggle(),e(t.currentTarget).prev("ul").slideToggle(function(){t.currentTarget.scrollIntoView()})}),e(".flexslider").each(function(t,n){var a=e(n);try{a.flexslider({namespace:"flex-",selector:".slides > li",animation:a.attr("data-animation"),easing:"swing",direction:"horizontal",reverse:!1,animationLoop:!0,smoothHeight:!1,startAt:0,slideshow:!0,slideshowSpeed:a.attr("data-slideshow-speed"),animationSpeed:a.attr("data-animation-speed"),initDelay:0,randomize:!0,pauseOnAction:!0,pauseOnHover:!1,useCSS:!0,touch:!0,video:!1,controlNav:a.attr("data-control-nav"),directionNav:a.attr("data-direction-nav"),prevText:"Previous",nextText:"Next",keyboard:!0,multipleKeyboard:!1,mousewheel:!1,pausePlay:!1,pauseText:"Pause",playText:"Play",controlsContainer:"",manualControls:"",sync:"",asNavFor:"",itemWidth:0,itemMargin:0,minItems:0,maxItems:0,move:0,start:function(e){MOB_show_slider_panels(e,a.attr("data-slideshow-speed"))},before:function(e){e.find("h2,.content").hide()},after:function(e){MOB_show_slider_panels(e,a.attr("data-slideshow-speed"))},end:function(){},added:function(){},removed:function(){}})}catch(i){console.log(i)}"false"==a.attr("data-control-nav")&&a.find(".flex-control-nav").hide()})});
jQuery(window).resize(function(){jQuery(".boxes")&&waitForFinalEvent(function(){jQuery(".boxes-item").css("height","auto"),jQuery(window).width()>=768&&jQuery(".boxes").each(function(e,i){var t=0,n=jQuery(i);n.find(".boxes-item").each(function(e,i){jQuery(i).outerHeight()>t&&(t=jQuery(i).outerHeight())}),n.find(".boxes-item").css({height:t})})},100,"make-boxes-equal-heights")}),waitForFinalEvent(function(){jQuery(window).trigger("resize")},100,"resizeBoxesOnResize");